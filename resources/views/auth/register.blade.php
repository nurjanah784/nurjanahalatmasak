...
<head>
    ...
    <title>PinjamPro · daftar peminjaman alat masak</title>
            ...
            <div class="content-wrapper">
                ...
                <div class="w-full bg-white rounded-lg shadow dark:border dark:bg-gray-800 dark:border-gray-700">
                    <div class="p-7 space-y-5 md:space-y-6 sm:p-9">
                        ...
                        <p class="text-sm text-gray-400 -mt-2">daftar untuk meminjam peralatan dapur berkualitas</p>

                        <form class="space-y-4 md:space-y-5" method="POST" action="/register">
                            @csrf
                            <div>
                            ...
                            <div class="flex items-start">
                                ...
                                <div class="ml-3 text-sm">
                                    <label for="terms" class="font-light text-gray-500 dark:text-gray-300">
                                        saya menyetujui <a class="font-medium text-primary-600 hover:underline dark:text-primary-500" href="#">syarat & ketentuan</a>
                                    </label>
                                </div>
                            </div>
